...
{   
    ...
    connect(m_aiController, &CommandDispatcher::dispatchResult, m_voiceWidget, &VoiceInputWidget::onDispatchResult);
    connect(m_aiController, &AiController::recognizing, m_voiceWidget, &VoiceInputWidget::onRecognizing);
    connect(m_aiController, &AiController::recognizeFailed, m_voiceWidget, &VoiceInputWidget::onRecognizeFaild);
}
